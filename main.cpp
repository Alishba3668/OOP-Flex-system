...
void  Administrator::addstudent()
{
	...
	cout << " Enter the data for the new student  " << endl;
	cout << "First Name  :  ";
	cin.ignore();
...
void Administrator::save_teacher()
{
...
void Administrator::add_teacher_object()
{
...
void Administrator::load_teacher()
{
...
void Administrator::save_student()
{
...
void Administrator::add_student_object()
{
...
void Administrator::load_student()
{
...
void Teacher::Asssign_attendece()
{
	system("cls");
